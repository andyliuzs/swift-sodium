...
s.homepage = 'https://github.com/andyliuzs/swift-sodium'
s.social_media_url = 'https://twitter.com/andyliuzs'
s.authors = { 'Frank Denis' => '' }
s.source = { :git => 'https://github.com/andyliuzs/swift-sodium.git',
             :tag => '0.7' }
