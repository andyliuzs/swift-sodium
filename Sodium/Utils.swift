...
public class Utils {
    ...
    /// - Parameter input:
    /// - Returns:
    public func base64Encode(_ input:String)throws -> String?{
    ...
    /// - Returns:
    public func base64Decode(_ base64String:String)throws -> String?{
        // 将base64字符串转换成NSData
    ...
    public func base64B2SEncode(_ input:Bytes)throws ->String{
    ...
    /// - Parameter input: <#input description#>
    /// - Returns: <#return value description#>
    public func base64S2BDecode(_ input:String)throws ->Bytes?{
