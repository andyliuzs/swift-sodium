...
public class KeySwitch:NSObject{
    ...
    ///
    /// - Returns: 公钥，私钥，ipv6
    public func createKeyPair() -> (privateKey:String,publicKey:String,ipv6:String){
        ...
        do{
            while(true) {
                ...
                ipv6 =  publicKey2Ipv6(publicKey:publicKey!)
    ...
    public func  publicKey2Ipv6(publicKey:String) -> String{
        ...
        do{
            ...
            var hashBuff = sodium.hash512.sha512(message: decode)!
            ...
            print("public key to ipv6 error")
        }
